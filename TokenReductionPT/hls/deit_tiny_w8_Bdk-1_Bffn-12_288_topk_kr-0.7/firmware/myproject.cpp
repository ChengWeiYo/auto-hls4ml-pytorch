...
#define elements_after_1st_pruning 43776 // 228 * 192
#define elements_after_2nd_pruning 30720 // 160 * 192
#define elements_after_3rd_pruning 21696 // 113 * 192
...
void myproject(
    ...
    #pragma HLS STREAM variable=layer18_topk_idx depth=62400
    ...
    #pragma HLS STREAM variable=layer24_topk_idx depth=62400
    ...
    #pragma HLS STREAM variable=layer30_topk_idx depth=62400
    ...
    // nnet::clone_stream<input_t, layer34_t, 62400>(src, layer95_cpy1, layer95_cpy2); // clone_layers_2_add2
