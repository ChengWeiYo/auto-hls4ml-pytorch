...
#define tokens_after_1st_pruning 139
#define tokens_after_2nd_pruning 98
#define tokens_after_3rd_pruning 69
...
typedef nnet::array<ap_fixed<18,4,AP_RND_CONV,AP_WRAP,0>, 1*1> layer35_t; // tf0*tf1
