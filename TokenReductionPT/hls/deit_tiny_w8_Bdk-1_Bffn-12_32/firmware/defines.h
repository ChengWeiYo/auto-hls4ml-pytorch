...
typedef ap_ufixed<18,2,AP_RND_CONV,AP_WRAP,0> layers_0_self_attn_row_sum_t;
...
typedef ap_fixed<18,-4,AP_RND_CONV,AP_WRAP,0> layers_1_norm1_mean_t;
...
typedef ap_fixed<24,4,AP_RND_CONV,AP_WRAP,0> layers_1_self_attn_out_proj_in_t;
...
typedef nnet::array<ap_fixed<18,3,AP_RND_CONV,AP_WRAP,0>, 1*1> layer26_t;
...
typedef ap_fixed<18,-5,AP_RND_CONV,AP_WRAP,0> layers_1_norm2_mean_t;
...
typedef ap_fixed<18,-5,AP_RND_CONV,AP_WRAP,0> layers_2_norm1_mean_t;
...
typedef ap_ufixed<18,2,AP_RND_CONV,AP_WRAP,0> layers_2_self_attn_row_sum_t;
...
typedef ap_ufixed<18,2,AP_RND_CONV,AP_WRAP,0> layers_3_self_attn_row_sum_t;
...
typedef ap_fixed<18,-4,AP_RND_CONV,AP_WRAP,0> layers_3_norm2_mean_t;
...
typedef ap_fixed<18,-4,AP_RND_CONV,AP_WRAP,0> layers_4_norm1_mean_t;
...
typedef ap_fixed<18,-4,AP_RND_CONV,AP_WRAP,0> layers_4_norm2_mean_t;
...
typedef ap_fixed<18,-4,AP_RND_CONV,AP_WRAP,0> layers_5_norm1_mean_t;
...
typedef ap_ufixed<18,2,AP_RND_CONV,AP_WRAP,0> layers_5_self_attn_row_sum_t;
...
typedef ap_fixed<18,-4,AP_RND_CONV,AP_WRAP,0> layers_5_norm2_mean_t;
...
typedef ap_fixed<18,-4,AP_RND_CONV,AP_WRAP,0> layers_6_norm1_mean_t;
...
typedef ap_fixed<24,4,AP_RND_CONV,AP_WRAP,0> layers_6_self_attn_out_proj_in_t;
...
typedef ap_fixed<18,-4,AP_RND_CONV,AP_WRAP,0> layers_6_norm2_mean_t;
...
typedef nnet::array<ap_fixed<18,2,AP_RND_CONV,AP_WRAP,0>, 1*1> layer63_t;
...
typedef ap_ufixed<18,2,AP_RND_CONV,AP_WRAP,0> layers_8_self_attn_row_sum_t;
...
typedef ap_fixed<24,3,AP_RND_CONV,AP_WRAP,0> layers_8_ffn_hidden_t;
...
typedef ap_fixed<18,-4,AP_RND_CONV,AP_WRAP,0> layers_9_norm1_mean_t;
...
typedef ap_fixed<18,-4,AP_RND_CONV,AP_WRAP,0> layers_9_norm2_mean_t;
...
typedef ap_ufixed<18,2,AP_RND_CONV,AP_WRAP,0> layers_11_self_attn_row_sum_t;
typedef ap_fixed<24,2,AP_RND_CONV,AP_WRAP,0> layers_11_self_attn_out_proj_in_t;
...
typedef nnet::array<ap_fixed<18,1,AP_RND_CONV,AP_WRAP,0>, 1*1> layer87_t;
