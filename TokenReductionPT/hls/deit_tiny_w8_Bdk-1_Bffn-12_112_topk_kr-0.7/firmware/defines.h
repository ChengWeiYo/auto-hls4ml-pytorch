...
#define tokens_after_1st_pruning 36
#define tokens_after_2nd_pruning 26
#define tokens_after_3rd_pruning 19
...
typedef ap_ufixed<18,4,AP_RND_CONV,AP_WRAP,0> layers_0_self_attn_row_sum_t;
...
typedef ap_ufixed<18,4,AP_RND_CONV,AP_WRAP,0> layers_1_self_attn_row_sum_t;
...
typedef ap_fixed<24,4,AP_RND_CONV,AP_WRAP,0> layers_2_self_attn_out_proj_in_t;
...
typedef nnet::array<ap_fixed<18,1,AP_RND_CONV,AP_WRAP,0>, 1*1> layer45_t;
...
typedef ap_fixed<24,4,AP_RND_CONV,AP_WRAP,0> layers_8_self_attn_out_proj_in_t;
...
typedef ap_fixed<24,5,AP_RND_CONV,AP_WRAP,0> layers_9_self_attn_out_proj_in_t;
