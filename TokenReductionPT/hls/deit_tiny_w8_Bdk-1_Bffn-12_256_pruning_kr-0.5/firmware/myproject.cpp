...
#define elements_after_1st_pruning 24768 // 129 * 192
#define elements_after_2nd_pruning 12480 // 65 * 192
#define elements_after_3rd_pruning 6336 // 33 * 192
...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<mask18_t, 66049>(mask18, "mask18.txt");
        ...
        nnet::load_weights_from_txt<mask24_t, 66049>(mask24, "mask24.txt");
        ...
        nnet::load_weights_from_txt<mask30_t, 66049>(mask30, "mask30.txt");
        ...
        nnet::load_weights_from_txt<mask36_t, 66049>(mask36, "mask36.txt");
        ...
        nnet::load_weights_from_txt<mask42_t, 66049>(mask42, "mask42.txt");
        ...
        nnet::load_weights_from_txt<mask48_t, 66049>(mask48, "mask48.txt");
        ...
        nnet::load_weights_from_txt<mask54_t, 66049>(mask54, "mask54.txt");
        ...
        nnet::load_weights_from_txt<mask60_t, 66049>(mask60, "mask60.txt");
        ...
        nnet::load_weights_from_txt<mask66_t, 66049>(mask66, "mask66.txt");
        ...
        nnet::load_weights_from_txt<mask72_t, 66049>(mask72, "mask72.txt");
        ...
        nnet::load_weights_from_txt<mask78_t, 66049>(mask78, "mask78.txt");
        ...
        nnet::load_weights_from_txt<mask84_t, 66049>(mask84, "mask84.txt");
    ...
    #pragma HLS STREAM variable=layer89_cpy1 depth=49344
    hls::stream<input_t> layer89_cpy2("layer89_cpy2");
    #pragma HLS STREAM variable=layer89_cpy2 depth=49344
    nnet::clone_stream<input_t, input_t, 49344>(src, layer89_cpy1, layer89_cpy2); // clone_src

    hls::stream<layer17_t> layer17_out("layer17_out");
    #pragma HLS STREAM variable=layer17_out depth=49344
    ...
    #pragma HLS STREAM variable=layer18_out depth=49344
    ...
    #pragma HLS STREAM variable=layer19_out depth=49344
    ...
    #pragma HLS STREAM variable=layer90_cpy1 depth=49344
    hls::stream<layer19_t> layer90_cpy2("layer90_cpy2");
    #pragma HLS STREAM variable=layer90_cpy2 depth=49344
    nnet::clone_stream<layer19_t, layer19_t, 49344>(layer19_out, layer90_cpy1, layer90_cpy2); // clone_layers_0_add1

    hls::stream<layer20_t> layer20_out("layer20_out");
    #pragma HLS STREAM variable=layer20_out depth=49344
    ...
    #pragma HLS STREAM variable=layer21_out depth=49344
    ...
    #pragma HLS STREAM variable=layer22_out depth=49344
    ...
    #pragma HLS STREAM variable=layer91_cpy1 depth=49344
    hls::stream<layer22_t> layer91_cpy2("layer91_cpy2");
    #pragma HLS STREAM variable=layer91_cpy2 depth=49344
    nnet::clone_stream<layer22_t, layer22_t, 49344>(layer22_out, layer91_cpy1, layer91_cpy2); // clone_layers_0_add2

    hls::stream<layer23_t> layer23_out("layer23_out");
    #pragma HLS STREAM variable=layer23_out depth=49344
    ...
    #pragma HLS STREAM variable=layer24_out depth=49344
    ...
    #pragma HLS STREAM variable=layer25_out depth=49344
    ...
    #pragma HLS STREAM variable=layer92_cpy1 depth=49344
    hls::stream<layer25_t> layer92_cpy2("layer92_cpy2");
    #pragma HLS STREAM variable=layer92_cpy2 depth=49344
    nnet::clone_stream<layer25_t, layer25_t, 49344>(layer25_out, layer92_cpy1, layer92_cpy2); // clone_layers_1_add1

    hls::stream<layer26_t> layer26_out("layer26_out");
    #pragma HLS STREAM variable=layer26_out depth=49344
    ...
    #pragma HLS STREAM variable=layer27_out depth=49344
    ...
    #pragma HLS STREAM variable=layer28_out depth=49344
    ...
    #pragma HLS STREAM variable=layer93_cpy1 depth=49344
    hls::stream<layer28_t> layer93_cpy2("layer93_cpy2");
    #pragma HLS STREAM variable=layer93_cpy2 depth=49344
    nnet::clone_stream<layer28_t, layer28_t, 49344>(layer28_out, layer93_cpy1, layer93_cpy2); // clone_layers_1_add2

    hls::stream<layer29_t> layer29_out("layer29_out");
    #pragma HLS STREAM variable=layer29_out depth=49344
    ...
    #pragma HLS STREAM variable=layer30_out depth=49344
    ...
    #pragma HLS STREAM variable=layer31_out depth=49344
    ...
    #pragma HLS STREAM variable=layer94_cpy1 depth=49344
    hls::stream<layer31_t> layer94_cpy2("layer94_cpy2");
    #pragma HLS STREAM variable=layer94_cpy2 depth=49344
    nnet::clone_stream<layer31_t, layer31_t, 49344>(layer31_out, layer94_cpy1, layer94_cpy2); // clone_layers_2_add1

    hls::stream<layer32_t> layer32_out("layer32_out");
    #pragma HLS STREAM variable=layer32_out depth=49344
    ...
    #pragma HLS STREAM variable=layer33_out depth=49344
    ...
    #pragma HLS STREAM variable=layer34_out depth=49344
    ...
    #pragma HLS STREAM variable=layer95_cpy1 depth=49344
    hls::stream<layer34_t> layer95_cpy2("layer95_cpy2");
    #pragma HLS STREAM variable=layer95_cpy2 depth=49344
    nnet::clone_stream<layer34_t, layer34_t, 49344>(layer34_out, layer95_cpy1, layer95_cpy2); // clone_layers_2_add2

    hls::stream<layer35_t> layer35_out("layer35_out");
    #pragma HLS STREAM variable=layer35_out depth=49344
    ...
    #pragma HLS STREAM variable=layer36_out depth=49344
    ...
    #pragma HLS STREAM variable=layer37_out depth=49344
