...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<mask18_t, 131044>(mask18, "mask18.txt");
        ...
        nnet::load_weights_from_txt<mask24_t, 131044>(mask24, "mask24.txt");
        ...
        nnet::load_weights_from_txt<mask30_t, 131044>(mask30, "mask30.txt");
        ...
        nnet::load_weights_from_txt<mask36_t, 131044>(mask36, "mask36.txt");
        ...
        nnet::load_weights_from_txt<mask42_t, 131044>(mask42, "mask42.txt");
        ...
        nnet::load_weights_from_txt<mask48_t, 131044>(mask48, "mask48.txt");
        ...
        nnet::load_weights_from_txt<mask54_t, 131044>(mask54, "mask54.txt");
        ...
        nnet::load_weights_from_txt<mask60_t, 131044>(mask60, "mask60.txt");
        ...
        nnet::load_weights_from_txt<mask66_t, 131044>(mask66, "mask66.txt");
        ...
        nnet::load_weights_from_txt<mask72_t, 131044>(mask72, "mask72.txt");
        ...
        nnet::load_weights_from_txt<mask78_t, 131044>(mask78, "mask78.txt");
        ...
        nnet::load_weights_from_txt<mask84_t, 131044>(mask84, "mask84.txt");
    ...
    #pragma HLS STREAM variable=layer89_cpy1 depth=69504
    hls::stream<input_t> layer89_cpy2("layer89_cpy2");
    #pragma HLS STREAM variable=layer89_cpy2 depth=69504
    nnet::clone_stream<input_t, input_t, 69504>(src, layer89_cpy1, layer89_cpy2); // clone_src

    hls::stream<layer17_t> layer17_out("layer17_out");
    #pragma HLS STREAM variable=layer17_out depth=69504
    ...
    #pragma HLS STREAM variable=layer18_out depth=69504
    ...
    #pragma HLS STREAM variable=layer19_out depth=69504
    ...
    #pragma HLS STREAM variable=layer90_cpy1 depth=69504
    hls::stream<layer19_t> layer90_cpy2("layer90_cpy2");
    #pragma HLS STREAM variable=layer90_cpy2 depth=69504
    nnet::clone_stream<layer19_t, layer19_t, 69504>(layer19_out, layer90_cpy1, layer90_cpy2); // clone_layers_0_add1

    hls::stream<layer20_t> layer20_out("layer20_out");
    #pragma HLS STREAM variable=layer20_out depth=69504
    ...
    #pragma HLS STREAM variable=layer21_out depth=69504
    ...
    #pragma HLS STREAM variable=layer22_out depth=69504
    ...
    #pragma HLS STREAM variable=layer91_cpy1 depth=69504
    hls::stream<layer22_t> layer91_cpy2("layer91_cpy2");
    #pragma HLS STREAM variable=layer91_cpy2 depth=69504
    nnet::clone_stream<layer22_t, layer22_t, 69504>(layer22_out, layer91_cpy1, layer91_cpy2); // clone_layers_0_add2

    hls::stream<layer23_t> layer23_out("layer23_out");
    #pragma HLS STREAM variable=layer23_out depth=69504
    ...
    #pragma HLS STREAM variable=layer24_out depth=69504
    ...
    #pragma HLS STREAM variable=layer25_out depth=69504
    ...
    #pragma HLS STREAM variable=layer92_cpy1 depth=69504
    hls::stream<layer25_t> layer92_cpy2("layer92_cpy2");
    #pragma HLS STREAM variable=layer92_cpy2 depth=69504
    nnet::clone_stream<layer25_t, layer25_t, 69504>(layer25_out, layer92_cpy1, layer92_cpy2); // clone_layers_1_add1

    hls::stream<layer26_t> layer26_out("layer26_out");
    #pragma HLS STREAM variable=layer26_out depth=69504
    ...
    #pragma HLS STREAM variable=layer27_out depth=69504
    ...
    #pragma HLS STREAM variable=layer28_out depth=69504
    ...
    #pragma HLS STREAM variable=layer93_cpy1 depth=69504
    hls::stream<layer28_t> layer93_cpy2("layer93_cpy2");
    #pragma HLS STREAM variable=layer93_cpy2 depth=69504
    nnet::clone_stream<layer28_t, layer28_t, 69504>(layer28_out, layer93_cpy1, layer93_cpy2); // clone_layers_1_add2

    hls::stream<layer29_t> layer29_out("layer29_out");
    #pragma HLS STREAM variable=layer29_out depth=69504
    ...
    #pragma HLS STREAM variable=layer30_out depth=69504
    ...
    #pragma HLS STREAM variable=layer31_out depth=69504
    ...
    #pragma HLS STREAM variable=layer94_cpy1 depth=69504
    hls::stream<layer31_t> layer94_cpy2("layer94_cpy2");
    #pragma HLS STREAM variable=layer94_cpy2 depth=69504
    nnet::clone_stream<layer31_t, layer31_t, 69504>(layer31_out, layer94_cpy1, layer94_cpy2); // clone_layers_2_add1

    hls::stream<layer32_t> layer32_out("layer32_out");
    #pragma HLS STREAM variable=layer32_out depth=69504
    ...
    #pragma HLS STREAM variable=layer33_out depth=69504
    ...
    #pragma HLS STREAM variable=layer34_out depth=69504
    ...
    #pragma HLS STREAM variable=layer95_cpy1 depth=69504
    hls::stream<layer34_t> layer95_cpy2("layer95_cpy2");
    #pragma HLS STREAM variable=layer95_cpy2 depth=69504
    nnet::clone_stream<layer34_t, layer34_t, 69504>(layer34_out, layer95_cpy1, layer95_cpy2); // clone_layers_2_add2

    hls::stream<layer35_t> layer35_out("layer35_out");
    #pragma HLS STREAM variable=layer35_out depth=69504
    ...
    #pragma HLS STREAM variable=layer36_out depth=69504
    ...
    #pragma HLS STREAM variable=layer37_out depth=69504
    ...
    #pragma HLS STREAM variable=layer96_cpy1 depth=69504
    hls::stream<layer37_t> layer96_cpy2("layer96_cpy2");
    #pragma HLS STREAM variable=layer96_cpy2 depth=69504
    nnet::clone_stream<layer37_t, layer37_t, 69504>(layer37_out, layer96_cpy1, layer96_cpy2); // clone_layers_3_add1

    hls::stream<layer38_t> layer38_out("layer38_out");
    #pragma HLS STREAM variable=layer38_out depth=69504
    ...
    #pragma HLS STREAM variable=layer39_out depth=69504
    ...
    #pragma HLS STREAM variable=layer40_out depth=69504
    ...
    #pragma HLS STREAM variable=layer97_cpy1 depth=69504
    hls::stream<layer40_t> layer97_cpy2("layer97_cpy2");
    #pragma HLS STREAM variable=layer97_cpy2 depth=69504
    nnet::clone_stream<layer40_t, layer40_t, 69504>(layer40_out, layer97_cpy1, layer97_cpy2); // clone_layers_3_add2

    hls::stream<layer41_t> layer41_out("layer41_out");
    #pragma HLS STREAM variable=layer41_out depth=69504
    ...
    #pragma HLS STREAM variable=layer42_out depth=69504
    ...
    #pragma HLS STREAM variable=layer43_out depth=69504
    ...
    #pragma HLS STREAM variable=layer98_cpy1 depth=69504
    hls::stream<layer43_t> layer98_cpy2("layer98_cpy2");
    #pragma HLS STREAM variable=layer98_cpy2 depth=69504
    nnet::clone_stream<layer43_t, layer43_t, 69504>(layer43_out, layer98_cpy1, layer98_cpy2); // clone_layers_4_add1

    hls::stream<layer44_t> layer44_out("layer44_out");
    #pragma HLS STREAM variable=layer44_out depth=69504
    ...
    #pragma HLS STREAM variable=layer45_out depth=69504
    ...
    #pragma HLS STREAM variable=layer46_out depth=69504
    ...
    #pragma HLS STREAM variable=layer99_cpy1 depth=69504
    hls::stream<layer46_t> layer99_cpy2("layer99_cpy2");
    #pragma HLS STREAM variable=layer99_cpy2 depth=69504
    nnet::clone_stream<layer46_t, layer46_t, 69504>(layer46_out, layer99_cpy1, layer99_cpy2); // clone_layers_4_add2

    hls::stream<layer47_t> layer47_out("layer47_out");
    #pragma HLS STREAM variable=layer47_out depth=69504
    ...
    #pragma HLS STREAM variable=layer48_out depth=69504
    ...
    #pragma HLS STREAM variable=layer49_out depth=69504
    ...
    #pragma HLS STREAM variable=layer100_cpy1 depth=69504
    hls::stream<layer49_t> layer100_cpy2("layer100_cpy2");
    #pragma HLS STREAM variable=layer100_cpy2 depth=69504
    nnet::clone_stream<layer49_t, layer49_t, 69504>(layer49_out, layer100_cpy1, layer100_cpy2); // clone_layers_5_add1

    hls::stream<layer50_t> layer50_out("layer50_out");
    #pragma HLS STREAM variable=layer50_out depth=69504
    ...
    #pragma HLS STREAM variable=layer51_out depth=69504
    ...
    #pragma HLS STREAM variable=layer52_out depth=69504
    ...
    #pragma HLS STREAM variable=layer101_cpy1 depth=69504
    hls::stream<layer52_t> layer101_cpy2("layer101_cpy2");
    #pragma HLS STREAM variable=layer101_cpy2 depth=69504
    nnet::clone_stream<layer52_t, layer52_t, 69504>(layer52_out, layer101_cpy1, layer101_cpy2); // clone_layers_5_add2

    hls::stream<layer53_t> layer53_out("layer53_out");
    #pragma HLS STREAM variable=layer53_out depth=69504
    ...
    #pragma HLS STREAM variable=layer54_out depth=69504
    ...
    #pragma HLS STREAM variable=layer55_out depth=69504
    ...
    #pragma HLS STREAM variable=layer102_cpy1 depth=69504
    hls::stream<layer55_t> layer102_cpy2("layer102_cpy2");
    #pragma HLS STREAM variable=layer102_cpy2 depth=69504
    nnet::clone_stream<layer55_t, layer55_t, 69504>(layer55_out, layer102_cpy1, layer102_cpy2); // clone_layers_6_add1

    hls::stream<layer56_t> layer56_out("layer56_out");
    #pragma HLS STREAM variable=layer56_out depth=69504
    ...
    #pragma HLS STREAM variable=layer57_out depth=69504
    ...
    #pragma HLS STREAM variable=layer58_out depth=69504
    ...
    #pragma HLS STREAM variable=layer103_cpy1 depth=69504
    hls::stream<layer58_t> layer103_cpy2("layer103_cpy2");
    #pragma HLS STREAM variable=layer103_cpy2 depth=69504
    nnet::clone_stream<layer58_t, layer58_t, 69504>(layer58_out, layer103_cpy1, layer103_cpy2); // clone_layers_6_add2

    hls::stream<layer59_t> layer59_out("layer59_out");
    #pragma HLS STREAM variable=layer59_out depth=69504
    ...
    #pragma HLS STREAM variable=layer60_out depth=69504
    ...
    #pragma HLS STREAM variable=layer61_out depth=69504
    ...
    #pragma HLS STREAM variable=layer104_cpy1 depth=69504
    hls::stream<layer61_t> layer104_cpy2("layer104_cpy2");
    #pragma HLS STREAM variable=layer104_cpy2 depth=69504
    nnet::clone_stream<layer61_t, layer61_t, 69504>(layer61_out, layer104_cpy1, layer104_cpy2); // clone_layers_7_add1

    hls::stream<layer62_t> layer62_out("layer62_out");
    #pragma HLS STREAM variable=layer62_out depth=69504
    ...
    #pragma HLS STREAM variable=layer63_out depth=69504
    ...
    #pragma HLS STREAM variable=layer64_out depth=69504
    ...
    #pragma HLS STREAM variable=layer105_cpy1 depth=69504
    hls::stream<layer64_t> layer105_cpy2("layer105_cpy2");
    #pragma HLS STREAM variable=layer105_cpy2 depth=69504
    nnet::clone_stream<layer64_t, layer64_t, 69504>(layer64_out, layer105_cpy1, layer105_cpy2); // clone_layers_7_add2

    hls::stream<layer65_t> layer65_out("layer65_out");
    #pragma HLS STREAM variable=layer65_out depth=69504
    ...
    #pragma HLS STREAM variable=layer66_out depth=69504
    ...
    #pragma HLS STREAM variable=layer67_out depth=69504
    ...
    #pragma HLS STREAM variable=layer106_cpy1 depth=69504
    hls::stream<layer67_t> layer106_cpy2("layer106_cpy2");
    #pragma HLS STREAM variable=layer106_cpy2 depth=69504
    nnet::clone_stream<layer67_t, layer67_t, 69504>(layer67_out, layer106_cpy1, layer106_cpy2); // clone_layers_8_add1

    hls::stream<layer68_t> layer68_out("layer68_out");
    #pragma HLS STREAM variable=layer68_out depth=69504
    ...
    #pragma HLS STREAM variable=layer69_out depth=69504
    ...
    #pragma HLS STREAM variable=layer70_out depth=69504
    ...
    #pragma HLS STREAM variable=layer107_cpy1 depth=69504
    hls::stream<layer70_t> layer107_cpy2("layer107_cpy2");
    #pragma HLS STREAM variable=layer107_cpy2 depth=69504
    nnet::clone_stream<layer70_t, layer70_t, 69504>(layer70_out, layer107_cpy1, layer107_cpy2); // clone_layers_8_add2

    hls::stream<layer71_t> layer71_out("layer71_out");
    #pragma HLS STREAM variable=layer71_out depth=69504
    ...
    #pragma HLS STREAM variable=layer72_out depth=69504
    ...
    #pragma HLS STREAM variable=layer73_out depth=69504
    ...
    #pragma HLS STREAM variable=layer108_cpy1 depth=69504
    hls::stream<layer73_t> layer108_cpy2("layer108_cpy2");
    #pragma HLS STREAM variable=layer108_cpy2 depth=69504
    nnet::clone_stream<layer73_t, layer73_t, 69504>(layer73_out, layer108_cpy1, layer108_cpy2); // clone_layers_9_add1

    hls::stream<layer74_t> layer74_out("layer74_out");
    #pragma HLS STREAM variable=layer74_out depth=69504
    ...
    #pragma HLS STREAM variable=layer75_out depth=69504
    ...
    #pragma HLS STREAM variable=layer76_out depth=69504
    ...
    #pragma HLS STREAM variable=layer109_cpy1 depth=69504
    hls::stream<layer76_t> layer109_cpy2("layer109_cpy2");
    #pragma HLS STREAM variable=layer109_cpy2 depth=69504
    nnet::clone_stream<layer76_t, layer76_t, 69504>(layer76_out, layer109_cpy1, layer109_cpy2); // clone_layers_9_add2

    hls::stream<layer77_t> layer77_out("layer77_out");
    #pragma HLS STREAM variable=layer77_out depth=69504
    ...
    #pragma HLS STREAM variable=layer78_out depth=69504
    ...
    #pragma HLS STREAM variable=layer79_out depth=69504
    ...
    #pragma HLS STREAM variable=layer110_cpy1 depth=69504
    hls::stream<layer79_t> layer110_cpy2("layer110_cpy2");
    #pragma HLS STREAM variable=layer110_cpy2 depth=69504
    nnet::clone_stream<layer79_t, layer79_t, 69504>(layer79_out, layer110_cpy1, layer110_cpy2); // clone_layers_10_add1

    hls::stream<layer80_t> layer80_out("layer80_out");
    #pragma HLS STREAM variable=layer80_out depth=69504
    ...
    #pragma HLS STREAM variable=layer81_out depth=69504
    ...
    #pragma HLS STREAM variable=layer82_out depth=69504
    ...
    #pragma HLS STREAM variable=layer111_cpy1 depth=69504
    hls::stream<layer82_t> layer111_cpy2("layer111_cpy2");
    #pragma HLS STREAM variable=layer111_cpy2 depth=69504
    nnet::clone_stream<layer82_t, layer82_t, 69504>(layer82_out, layer111_cpy1, layer111_cpy2); // clone_layers_10_add2

    hls::stream<layer83_t> layer83_out("layer83_out");
    #pragma HLS STREAM variable=layer83_out depth=69504
    ...
    #pragma HLS STREAM variable=layer84_out depth=69504
    ...
    #pragma HLS STREAM variable=layer85_out depth=69504
    ...
    #pragma HLS STREAM variable=layer112_cpy1 depth=69504
    hls::stream<layer85_t> layer112_cpy2("layer112_cpy2");
    #pragma HLS STREAM variable=layer112_cpy2 depth=69504
    nnet::clone_stream<layer85_t, layer85_t, 69504>(layer85_out, layer112_cpy1, layer112_cpy2); // clone_layers_11_add1

    hls::stream<layer86_t> layer86_out("layer86_out");
    #pragma HLS STREAM variable=layer86_out depth=69504
    ...
    #pragma HLS STREAM variable=layer87_out depth=69504
    ...
    #pragma HLS STREAM variable=layer88_out depth=69504
