...
typedef ap_ufixed<18,9,AP_RND_CONV,AP_WRAP,0> layers_0_self_attn_row_sum_t;
...
typedef ap_ufixed<18,7,AP_RND_CONV,AP_WRAP,0> layers_5_self_attn_row_sum_t;
typedef ap_fixed<24,8,AP_RND_CONV,AP_WRAP,0> layers_5_self_attn_out_proj_in_t;
...
typedef ap_fixed<24,8,AP_RND_CONV,AP_WRAP,0> layers_6_self_attn_out_proj_in_t;
