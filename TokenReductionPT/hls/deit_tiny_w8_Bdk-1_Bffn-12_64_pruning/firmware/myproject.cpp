...
// #define elements_after_1st_pruning 3264
// #define elements_after_2nd_pruning 3264
// #define elements_after_3rd_pruning 3264
...
void myproject(
    ...
    #pragma HLS STREAM variable=layer18_topk_idx depth=3264
    ...
    #pragma HLS STREAM variable=layer24_topk_idx depth=3264
    ...
    #pragma HLS STREAM variable=layer30_topk_idx depth=3264
    ...
    #pragma HLS STREAM variable=layer36_topk_idx depth=3264
    ...
    nnet::PruningLayer<layer37_t, layer37_t, config_prune>(
        ...
        layer36_topk_idx,   // <-- 新增: Top-K 索引串流
        0.5,                // keep rate
...
// std::cout << "clone done" << std::endl;
    ...
    #pragma HLS STREAM variable=layer54_topk_idx depth=elements_after_1st_pruning
...
// std::cout << "FeedForwardNetwork done" << std::endl;
    ...
    #pragma HLS STREAM variable=layer72_topk_idx depth=elements_after_2nd_pruning
