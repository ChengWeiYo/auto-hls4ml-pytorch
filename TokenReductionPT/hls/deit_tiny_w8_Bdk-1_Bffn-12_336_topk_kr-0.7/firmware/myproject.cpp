...
#define elements_after_1st_pruning 59520 // 310 * 192
#define elements_after_2nd_pruning 41856 // 218 * 192
#define elements_after_3rd_pruning 29376 // 153 * 192
...
void myproject(
    ...
    #pragma HLS STREAM variable=layer18_topk_idx depth=84864
    ...
    #pragma HLS STREAM variable=layer24_topk_idx depth=84864
    ...
    #pragma HLS STREAM variable=layer30_topk_idx depth=84864
    ...
    // nnet::clone_stream<input_t, layer34_t, 84864>(src, layer95_cpy1, layer95_cpy2); // clone_layers_2_add2
