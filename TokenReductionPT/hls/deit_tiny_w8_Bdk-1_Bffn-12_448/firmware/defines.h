...
typedef ap_ufixed<18,8,AP_RND_CONV,AP_WRAP,0> layers_1_self_attn_row_sum_t;
...
typedef ap_fixed<24,8,AP_RND_CONV,AP_WRAP,0> layers_10_self_attn_out_proj_in_t;
