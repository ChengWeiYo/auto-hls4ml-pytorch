...
#define elements_after_1st_pruning 4032 // 21 * 192
#define elements_after_2nd_pruning 576 // 3 * 192
#define elements_after_3rd_pruning 384 // 2 * 192
...
// #define elements_after_1st_pruning 37824 // 1*197*192
// #define elements_after_2nd_pruning 37824
// #define elements_after_3rd_pruning 37824

void myproject(
    hls::stream<input_t> &src,
    hls::stream<result_t> &layer4_out
    // hls::stream<input_t> &layer37_out_pruned
)
{
...
// hls-fpga-machine-learning insert IO
    ...
    if (!loaded_weights)
    {
        ...
        nnet::load_weights_from_txt<mask18_t, 38809>(mask18, "mask18.txt");
        ...
        nnet::load_weights_from_txt<mask24_t, 38809>(mask24, "mask24.txt");
        ...
        nnet::load_weights_from_txt<mask30_t, 38809>(mask30, "mask30.txt");
        ...
        nnet::load_weights_from_txt<mask36_t, 38809>(mask36, "mask36.txt");
        ...
        nnet::load_weights_from_txt<mask42_t, 38809>(mask42, "mask42.txt");
        ...
        nnet::load_weights_from_txt<mask48_t, 38809>(mask48, "mask48.txt");
        ...
        nnet::load_weights_from_txt<mask54_t, 38809>(mask54, "mask54.txt");
        ...
        nnet::load_weights_from_txt<mask60_t, 38809>(mask60, "mask60.txt");
        ...
        nnet::load_weights_from_txt<mask66_t, 38809>(mask66, "mask66.txt");
        ...
        nnet::load_weights_from_txt<mask72_t, 38809>(mask72, "mask72.txt");
        ...
        nnet::load_weights_from_txt<mask78_t, 38809>(mask78, "mask78.txt");
        ...
        nnet::load_weights_from_txt<mask84_t, 38809>(mask84, "mask84.txt");
    ...
    #pragma HLS STREAM variable = layer89_cpy1 depth = 37824
    hls::stream<input_t> layer89_cpy2("layer89_cpy2");
    #pragma HLS STREAM variable = layer89_cpy2 depth = 37824
    nnet::clone_stream<input_t, input_t, 37824>(src, layer89_cpy1, layer89_cpy2); // clone_src

    hls::stream<layer17_t> layer17_out("layer17_out");
    #pragma HLS STREAM variable = layer17_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer18_out depth = 37824
    nnet::MultiHeadAttention<layer17_t, layer18_t, config18>(layer17_out, layer18_out, in_proj_weight18, in_proj_bias18, out_proj_weight18, out_proj_bias18, mask18); // layers_0_self_attn

    hls::stream<layer19_t> layer19_out("layer19_out");
    #pragma HLS STREAM variable = layer19_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer90_cpy1 depth = 37824
    hls::stream<layer19_t> layer90_cpy2("layer90_cpy2");
    #pragma HLS STREAM variable = layer90_cpy2 depth = 37824
    nnet::clone_stream<layer19_t, layer19_t, 37824>(layer19_out, layer90_cpy1, layer90_cpy2); // clone_layers_0_add1

    hls::stream<layer20_t> layer20_out("layer20_out");
    #pragma HLS STREAM variable = layer20_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer21_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer22_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer91_cpy1 depth = 37824
    hls::stream<layer22_t> layer91_cpy2("layer91_cpy2");
    #pragma HLS STREAM variable = layer91_cpy2 depth = 37824
    nnet::clone_stream<layer22_t, layer22_t, 37824>(layer22_out, layer91_cpy1, layer91_cpy2); // clone_layers_0_add2

    hls::stream<layer23_t> layer23_out("layer23_out");
    #pragma HLS STREAM variable = layer23_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer24_out depth = 37824
    nnet::MultiHeadAttention<layer23_t, layer24_t, config24>(layer23_out, layer24_out, in_proj_weight24, in_proj_bias24, out_proj_weight24, out_proj_bias24, mask24); // layers_1_self_attn

    hls::stream<layer25_t> layer25_out("layer25_out");
    #pragma HLS STREAM variable = layer25_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer92_cpy1 depth = 37824
    hls::stream<layer25_t> layer92_cpy2("layer92_cpy2");
    #pragma HLS STREAM variable = layer92_cpy2 depth = 37824
    nnet::clone_stream<layer25_t, layer25_t, 37824>(layer25_out, layer92_cpy1, layer92_cpy2); // clone_layers_1_add1

    hls::stream<layer26_t> layer26_out("layer26_out");
    #pragma HLS STREAM variable = layer26_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer27_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer28_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer93_cpy1 depth = 37824
    hls::stream<layer28_t> layer93_cpy2("layer93_cpy2");
    #pragma HLS STREAM variable = layer93_cpy2 depth = 37824
    nnet::clone_stream<layer28_t, layer28_t, 37824>(layer28_out, layer93_cpy1, layer93_cpy2); // clone_layers_1_add2

    hls::stream<layer29_t> layer29_out("layer29_out");
    #pragma HLS STREAM variable = layer29_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer30_out depth = 37824
    nnet::MultiHeadAttention<layer29_t, layer30_t, config30>(layer29_out, layer30_out, in_proj_weight30, in_proj_bias30, out_proj_weight30, out_proj_bias30, mask30); // layers_2_self_attn

    hls::stream<layer31_t> layer31_out("layer31_out");
    #pragma HLS STREAM variable = layer31_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer94_cpy1 depth = 37824
    hls::stream<layer31_t> layer94_cpy2("layer94_cpy2");
    #pragma HLS STREAM variable = layer94_cpy2 depth = 37824
    nnet::clone_stream<layer31_t, layer31_t, 37824>(layer31_out, layer94_cpy1, layer94_cpy2); // clone_layers_2_add1

    hls::stream<layer32_t> layer32_out("layer32_out");
    #pragma HLS STREAM variable = layer32_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer33_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer34_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer95_cpy1 depth = 37824
    hls::stream<layer34_t> layer95_cpy2("layer95_cpy2");
    #pragma HLS STREAM variable = layer95_cpy2 depth = 37824
    nnet::clone_stream<layer34_t, layer34_t, 37824>(layer34_out, layer95_cpy1, layer95_cpy2); // clone_layers_2_add2

    hls::stream<layer35_t> layer35_out("layer35_out");
    #pragma HLS STREAM variable = layer35_out depth = 37824
    ...
    #pragma HLS STREAM variable = layer36_out depth = 37824
    nnet::MultiHeadAttention<layer35_t, layer36_t, config36>(layer35_out, layer36_out, in_proj_weight36, in_proj_bias36, out_proj_weight36, out_proj_bias36, mask36); // layers_3_self_attn

    hls::stream<layer37_t> layer37_out("layer37_out");
    #pragma HLS STREAM variable = layer37_out depth = 37824
    ...
    #pragma HLS STREAM variable=layer37_out_pruned depth=elements_after_1st_pruning
    nnet::PruningLayer<layer37_t, layer37_t, config_prune>(
        layer37_out,        // 輸入Token流
        layer37_out_pruned, // 輸出保留Token流
        // 2,            // 每2個輸入元素進行一次pruning
        0.1,                // keep rate
        197                // Input Token Number
    );
    // std::cout << "1st pruning done" << std::endl;

    hls::stream<layer37_t> layer96_cpy1("layer96_cpy1");
    #pragma HLS STREAM variable = layer96_cpy1 depth = elements_after_1st_pruning
    hls::stream<layer37_t> layer96_cpy2("layer96_cpy2");
    #pragma HLS STREAM variable = layer96_cpy2 depth = elements_after_1st_pruning
...
// std::cout << "clone done" << std::endl;
    ...
    #pragma HLS STREAM variable = layer38_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer39_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer40_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer97_cpy1 depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer41_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer42_out depth = elements_after_1st_pruning
    nnet::MultiHeadAttention<layer41_t, layer42_t, config42>(layer41_out, layer42_out, in_proj_weight42, in_proj_bias42, out_proj_weight42, out_proj_bias42, mask42); // layers_4_self_attn
// std::cout << "MultiHeadAttention done" << std::endl;
    hls::stream<layer43_t> layer43_out("layer43_out");
    #pragma HLS STREAM variable = layer43_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer98_cpy1 depth = elements_after_1st_pruning
    hls::stream<layer43_t> layer98_cpy2("layer98_cpy2");
    #pragma HLS STREAM variable = layer98_cpy2 depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer44_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer45_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer46_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer99_cpy1 depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer47_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer48_out depth = elements_after_1st_pruning
    nnet::MultiHeadAttention<layer47_t, layer48_t, config48>(layer47_out, layer48_out, in_proj_weight48, in_proj_bias48, out_proj_weight48, out_proj_bias48, mask48); // layers_5_self_attn

    hls::stream<layer49_t> layer49_out("layer49_out");
    #pragma HLS STREAM variable = layer49_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer100_cpy1 depth = elements_after_1st_pruning
    hls::stream<layer49_t> layer100_cpy2("layer100_cpy2");
    #pragma HLS STREAM variable = layer100_cpy2 depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer50_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer51_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer52_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer101_cpy1 depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer53_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable = layer54_out depth = elements_after_1st_pruning
    nnet::MultiHeadAttention<layer53_t, layer54_t, config54>(layer53_out, layer54_out, in_proj_weight54, in_proj_bias54, out_proj_weight54, out_proj_bias54, mask54); // layers_6_self_attn

    hls::stream<layer55_t> layer55_out("layer55_out");
    #pragma HLS STREAM variable = layer55_out depth = elements_after_1st_pruning
    ...
    #pragma HLS STREAM variable=layer55_out_pruned depth=elements_after_2nd_pruning
    nnet::PruningLayer<layer55_t, layer55_t, config_prune>(
        layer55_out,  // 輸入Token流
        layer55_out_pruned, // 輸出保留Token流
        // 2,            // 每2個輸入元素進行一次pruning
        0.1,                // keep rate
        21                // Input Token Number
    );
    // std::cout << "2nd pruning done" << std::endl;

    hls::stream<layer55_t> layer102_cpy1("layer102_cpy1");
    #pragma HLS STREAM variable = layer102_cpy1 depth = elements_after_2nd_pruning
    hls::stream<layer55_t> layer102_cpy2("layer102_cpy2");
    #pragma HLS STREAM variable = layer102_cpy2 depth = elements_after_2nd_pruning
...
// std::cout << "clone done" << std::endl;
    ...
    #pragma HLS STREAM variable = layer56_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer57_out depth = elements_after_2nd_pruning
...
// std::cout << "FeedForwardNetwork done" << std::endl;
    ...
    #pragma HLS STREAM variable = layer58_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer103_cpy1 depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer59_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer60_out depth = elements_after_2nd_pruning
    nnet::MultiHeadAttention<layer59_t, layer60_t, config60>(layer59_out, layer60_out, in_proj_weight60, in_proj_bias60, out_proj_weight60, out_proj_bias60, mask60); // layers_7_self_attn
// std::cout << "MultiHeadAttention done" << std::endl;
    hls::stream<layer61_t> layer61_out("layer61_out");
    #pragma HLS STREAM variable = layer61_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer104_cpy1 depth = elements_after_2nd_pruning
    hls::stream<layer61_t> layer104_cpy2("layer104_cpy2");
    #pragma HLS STREAM variable = layer104_cpy2 depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer62_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer63_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer64_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer105_cpy1 depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer65_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer66_out depth = elements_after_2nd_pruning
    nnet::MultiHeadAttention<layer65_t, layer66_t, config66>(layer65_out, layer66_out, in_proj_weight66, in_proj_bias66, out_proj_weight66, out_proj_bias66, mask66); // layers_8_self_attn

    hls::stream<layer67_t> layer67_out("layer67_out");
    #pragma HLS STREAM variable = layer67_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer106_cpy1 depth = elements_after_2nd_pruning
    hls::stream<layer67_t> layer106_cpy2("layer106_cpy2");
    #pragma HLS STREAM variable = layer106_cpy2 depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer68_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer69_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer70_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer107_cpy1 depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer71_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable = layer72_out depth = elements_after_2nd_pruning
    nnet::MultiHeadAttention<layer71_t, layer72_t, config72>(layer71_out, layer72_out, in_proj_weight72, in_proj_bias72, out_proj_weight72, out_proj_bias72, mask72); // layers_9_self_attn

    hls::stream<layer73_t> layer73_out("layer73_out");
    #pragma HLS STREAM variable = layer73_out depth = elements_after_2nd_pruning
    ...
    #pragma HLS STREAM variable=layer73_out_pruned depth=elements_after_3rd_pruning
    nnet::PruningLayer<layer73_t, layer73_t, config_prune>(
        layer73_out,  // 輸入Token流
        layer73_out_pruned, // 輸出保留Token流
        // 2,            // 每2個輸入元素進行一次pruning
        0.1,                // keep rate
        3                // Input Token Number
    );
    // std::cout << "3rd pruning done" << std::endl;

    hls::stream<layer73_t> layer108_cpy1("layer108_cpy1");
    #pragma HLS STREAM variable = layer108_cpy1 depth = elements_after_3rd_pruning
    hls::stream<layer73_t> layer108_cpy2("layer108_cpy2");
    #pragma HLS STREAM variable = layer108_cpy2 depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer74_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer75_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer76_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer109_cpy1 depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer77_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer78_out depth = elements_after_3rd_pruning
    nnet::MultiHeadAttention<layer77_t, layer78_t, config78>(layer77_out, layer78_out, in_proj_weight78, in_proj_bias78, out_proj_weight78, out_proj_bias78, mask78); // layers_10_self_attn

    hls::stream<layer79_t> layer79_out("layer79_out");
    #pragma HLS STREAM variable = layer79_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer110_cpy1 depth = elements_after_3rd_pruning
    hls::stream<layer79_t> layer110_cpy2("layer110_cpy2");
    #pragma HLS STREAM variable = layer110_cpy2 depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer80_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer81_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer82_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer111_cpy1 depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer83_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer84_out depth = elements_after_3rd_pruning
    nnet::MultiHeadAttention<layer83_t, layer84_t, config84>(layer83_out, layer84_out, in_proj_weight84, in_proj_bias84, out_proj_weight84, out_proj_bias84, mask84); // layers_11_self_attn

    hls::stream<layer85_t> layer85_out("layer85_out");
    #pragma HLS STREAM variable = layer85_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer112_cpy1 depth = elements_after_3rd_pruning
    hls::stream<layer85_t> layer112_cpy2("layer112_cpy2");
    #pragma HLS STREAM variable = layer112_cpy2 depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer86_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer87_out depth = elements_after_3rd_pruning
    ...
    #pragma HLS STREAM variable = layer88_out depth = elements_after_3rd_pruning
