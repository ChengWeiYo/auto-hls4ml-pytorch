...
void myproject(
    ...
    #pragma HLS STREAM variable=layer96_cpy1 depth=37824
    hls::stream<layer37_t> layer96_cpy2("layer96_cpy2");
    #pragma HLS STREAM variable=layer96_cpy2 depth=37824
    nnet::clone_stream<layer37_t, layer37_t, 37824>(layer37_out, layer96_cpy1, layer96_cpy2); // clone_layers_3_add1

    hls::stream<layer38_t> layer38_out("layer38_out");
    #pragma HLS STREAM variable=layer38_out depth=37824
    ...
    #pragma HLS STREAM variable=layer39_out depth=37824
    ...
    #pragma HLS STREAM variable=layer40_out depth=37824
    ...
    #pragma HLS STREAM variable=layer97_cpy1 depth=37824
    hls::stream<layer40_t> layer97_cpy2("layer97_cpy2");
    #pragma HLS STREAM variable=layer97_cpy2 depth=37824
    nnet::clone_stream<layer40_t, layer40_t, 37824>(layer40_out, layer97_cpy1, layer97_cpy2); // clone_layers_3_add2

    hls::stream<layer41_t> layer41_out("layer41_out");
    #pragma HLS STREAM variable=layer41_out depth=37824
    ...
    #pragma HLS STREAM variable=layer42_out depth=37824
    ...
    #pragma HLS STREAM variable=layer43_out depth=37824
    ...
    #pragma HLS STREAM variable=layer98_cpy1 depth=37824
    hls::stream<layer43_t> layer98_cpy2("layer98_cpy2");
    #pragma HLS STREAM variable=layer98_cpy2 depth=37824
    nnet::clone_stream<layer43_t, layer43_t, 37824>(layer43_out, layer98_cpy1, layer98_cpy2); // clone_layers_4_add1

    hls::stream<layer44_t> layer44_out("layer44_out");
    #pragma HLS STREAM variable=layer44_out depth=37824
    ...
    #pragma HLS STREAM variable=layer45_out depth=37824
    ...
    #pragma HLS STREAM variable=layer46_out depth=37824
    ...
    #pragma HLS STREAM variable=layer99_cpy1 depth=37824
    hls::stream<layer46_t> layer99_cpy2("layer99_cpy2");
    #pragma HLS STREAM variable=layer99_cpy2 depth=37824
    nnet::clone_stream<layer46_t, layer46_t, 37824>(layer46_out, layer99_cpy1, layer99_cpy2); // clone_layers_4_add2

    hls::stream<layer47_t> layer47_out("layer47_out");
    #pragma HLS STREAM variable=layer47_out depth=37824
    ...
    #pragma HLS STREAM variable=layer48_out depth=37824
    ...
    #pragma HLS STREAM variable=layer49_out depth=37824
    ...
    #pragma HLS STREAM variable=layer100_cpy1 depth=37824
    hls::stream<layer49_t> layer100_cpy2("layer100_cpy2");
    #pragma HLS STREAM variable=layer100_cpy2 depth=37824
    nnet::clone_stream<layer49_t, layer49_t, 37824>(layer49_out, layer100_cpy1, layer100_cpy2); // clone_layers_5_add1

    hls::stream<layer50_t> layer50_out("layer50_out");
    #pragma HLS STREAM variable=layer50_out depth=37824
    ...
    #pragma HLS STREAM variable=layer51_out depth=37824
    ...
    #pragma HLS STREAM variable=layer52_out depth=37824
    ...
    #pragma HLS STREAM variable=layer101_cpy1 depth=37824
    hls::stream<layer52_t> layer101_cpy2("layer101_cpy2");
    #pragma HLS STREAM variable=layer101_cpy2 depth=37824
    nnet::clone_stream<layer52_t, layer52_t, 37824>(layer52_out, layer101_cpy1, layer101_cpy2); // clone_layers_5_add2

    hls::stream<layer53_t> layer53_out("layer53_out");
    #pragma HLS STREAM variable=layer53_out depth=37824
    ...
    #pragma HLS STREAM variable=layer54_out depth=37824
    ...
    #pragma HLS STREAM variable=layer55_out depth=37824
    ...
    #pragma HLS STREAM variable=layer102_cpy1 depth=37824
    hls::stream<layer55_t> layer102_cpy2("layer102_cpy2");
    #pragma HLS STREAM variable=layer102_cpy2 depth=37824
    nnet::clone_stream<layer55_t, layer55_t, 37824>(layer55_out, layer102_cpy1, layer102_cpy2); // clone_layers_6_add1

    hls::stream<layer56_t> layer56_out("layer56_out");
    #pragma HLS STREAM variable=layer56_out depth=37824
    ...
    #pragma HLS STREAM variable=layer57_out depth=37824
    ...
    #pragma HLS STREAM variable=layer58_out depth=37824
    ...
    #pragma HLS STREAM variable=layer103_cpy1 depth=37824
    hls::stream<layer58_t> layer103_cpy2("layer103_cpy2");
    #pragma HLS STREAM variable=layer103_cpy2 depth=37824
    nnet::clone_stream<layer58_t, layer58_t, 37824>(layer58_out, layer103_cpy1, layer103_cpy2); // clone_layers_6_add2

    hls::stream<layer59_t> layer59_out("layer59_out");
    #pragma HLS STREAM variable=layer59_out depth=37824
    ...
    #pragma HLS STREAM variable=layer60_out depth=37824
    ...
    #pragma HLS STREAM variable=layer61_out depth=37824
    ...
    #pragma HLS STREAM variable=layer104_cpy1 depth=37824
    hls::stream<layer61_t> layer104_cpy2("layer104_cpy2");
    #pragma HLS STREAM variable=layer104_cpy2 depth=37824
    nnet::clone_stream<layer61_t, layer61_t, 37824>(layer61_out, layer104_cpy1, layer104_cpy2); // clone_layers_7_add1

    hls::stream<layer62_t> layer62_out("layer62_out");
    #pragma HLS STREAM variable=layer62_out depth=37824
    ...
    #pragma HLS STREAM variable=layer63_out depth=37824
    ...
    #pragma HLS STREAM variable=layer64_out depth=37824
    ...
    #pragma HLS STREAM variable=layer105_cpy1 depth=37824
    hls::stream<layer64_t> layer105_cpy2("layer105_cpy2");
    #pragma HLS STREAM variable=layer105_cpy2 depth=37824
    nnet::clone_stream<layer64_t, layer64_t, 37824>(layer64_out, layer105_cpy1, layer105_cpy2); // clone_layers_7_add2

    hls::stream<layer65_t> layer65_out("layer65_out");
    #pragma HLS STREAM variable=layer65_out depth=37824
    ...
    #pragma HLS STREAM variable=layer66_out depth=37824
    ...
    #pragma HLS STREAM variable=layer67_out depth=37824
    ...
    #pragma HLS STREAM variable=layer106_cpy1 depth=37824
    hls::stream<layer67_t> layer106_cpy2("layer106_cpy2");
    #pragma HLS STREAM variable=layer106_cpy2 depth=37824
    nnet::clone_stream<layer67_t, layer67_t, 37824>(layer67_out, layer106_cpy1, layer106_cpy2); // clone_layers_8_add1

    hls::stream<layer68_t> layer68_out("layer68_out");
    #pragma HLS STREAM variable=layer68_out depth=37824
    ...
    #pragma HLS STREAM variable=layer69_out depth=37824
    ...
    #pragma HLS STREAM variable=layer70_out depth=37824
    ...
    #pragma HLS STREAM variable=layer107_cpy1 depth=37824
    hls::stream<layer70_t> layer107_cpy2("layer107_cpy2");
    #pragma HLS STREAM variable=layer107_cpy2 depth=37824
    nnet::clone_stream<layer70_t, layer70_t, 37824>(layer70_out, layer107_cpy1, layer107_cpy2); // clone_layers_8_add2

    hls::stream<layer71_t> layer71_out("layer71_out");
    #pragma HLS STREAM variable=layer71_out depth=37824
    ...
    #pragma HLS STREAM variable=layer72_out depth=37824
    ...
    #pragma HLS STREAM variable=layer73_out depth=37824
    ...
    #pragma HLS STREAM variable=layer108_cpy1 depth=37824
    hls::stream<layer73_t> layer108_cpy2("layer108_cpy2");
    #pragma HLS STREAM variable=layer108_cpy2 depth=37824
    nnet::clone_stream<layer73_t, layer73_t, 37824>(layer73_out, layer108_cpy1, layer108_cpy2); // clone_layers_9_add1

    hls::stream<layer74_t> layer74_out("layer74_out");
    #pragma HLS STREAM variable=layer74_out depth=37824
    ...
    #pragma HLS STREAM variable=layer75_out depth=37824
    ...
    #pragma HLS STREAM variable=layer76_out depth=37824
    ...
    #pragma HLS STREAM variable=layer109_cpy1 depth=37824
    hls::stream<layer76_t> layer109_cpy2("layer109_cpy2");
    #pragma HLS STREAM variable=layer109_cpy2 depth=37824
    nnet::clone_stream<layer76_t, layer76_t, 37824>(layer76_out, layer109_cpy1, layer109_cpy2); // clone_layers_9_add2

    hls::stream<layer77_t> layer77_out("layer77_out");
    #pragma HLS STREAM variable=layer77_out depth=37824
    ...
    #pragma HLS STREAM variable=layer78_out depth=37824
    ...
    #pragma HLS STREAM variable=layer79_out depth=37824
    ...
    #pragma HLS STREAM variable=layer110_cpy1 depth=37824
    hls::stream<layer79_t> layer110_cpy2("layer110_cpy2");
    #pragma HLS STREAM variable=layer110_cpy2 depth=37824
    nnet::clone_stream<layer79_t, layer79_t, 37824>(layer79_out, layer110_cpy1, layer110_cpy2); // clone_layers_10_add1

    hls::stream<layer80_t> layer80_out("layer80_out");
    #pragma HLS STREAM variable=layer80_out depth=37824
    ...
    #pragma HLS STREAM variable=layer81_out depth=37824
    ...
    #pragma HLS STREAM variable=layer82_out depth=37824
    ...
    #pragma HLS STREAM variable=layer111_cpy1 depth=37824
    hls::stream<layer82_t> layer111_cpy2("layer111_cpy2");
    #pragma HLS STREAM variable=layer111_cpy2 depth=37824
    nnet::clone_stream<layer82_t, layer82_t, 37824>(layer82_out, layer111_cpy1, layer111_cpy2); // clone_layers_10_add2

    hls::stream<layer83_t> layer83_out("layer83_out");
    #pragma HLS STREAM variable=layer83_out depth=37824
    ...
    #pragma HLS STREAM variable=layer84_out depth=37824
    ...
    #pragma HLS STREAM variable=layer85_out depth=37824
    ...
    #pragma HLS STREAM variable=layer112_cpy1 depth=37824
    hls::stream<layer85_t> layer112_cpy2("layer112_cpy2");
    #pragma HLS STREAM variable=layer112_cpy2 depth=37824
    nnet::clone_stream<layer85_t, layer85_t, 37824>(layer85_out, layer112_cpy1, layer112_cpy2); // clone_layers_11_add1

    hls::stream<layer86_t> layer86_out("layer86_out");
    #pragma HLS STREAM variable=layer86_out depth=37824
    ...
    #pragma HLS STREAM variable=layer87_out depth=37824
    ...
    #pragma HLS STREAM variable=layer88_out depth=37824
