...
def setup_environment(args):
    ...
    loader_train = torch.utils.data.DataLoader(
        dataset_train, shuffle=args.random_sampler,
...
def main():
    ...
    parser.add_argument('--random_sampler', action='store_false', help='def uses random sampler')
    ...
    parser.add_argument('--vis_cols', type=int, default=8,
                        help='how many columns when visualizing images')
    parser.set_defaults(output_dir='results_inference', batch_size=8)
