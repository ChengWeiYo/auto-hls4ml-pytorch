...
def get_args_parser():
    ...
    parser.add_argument('--use_amp', action='store_false', help="")
    ...
    # hls4ml
    parser.add_argument('--calibration', action='store_true', help='calibrate the quantizer')
...
def main(args):
    ...
    if utils.is_main_process():
        ...
        setattr(args, 'num_images_test', len(dataset_val))
    ...
    if total_epochs == 0:
        ...
        for epoch in range(args.start_epoch, total_epochs):
            ...
            train_stats, total_step = train_one_epoch(
                ...
                output_dir=args.output_dir, debugging=args.debugging
            )
